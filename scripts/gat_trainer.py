...
from src.models.GNN import GraphAttnTransformer
...
def train_result(df_copy, ps, param_dict, device):
    ...
    for cv, (train_idx, valid_idx) in enumerate(ps.split()):
        ...
        model = GraphAttnTransformer(input_size=param_dict['input_size'], hidden_size=param_dict['hidden_size'], output_size=param_dict['output_size'], 
